        ...
        <div class="footer-container">
            ...
            <div class="footer-col">
                ...
                <ul>
                    ...
                    <li><a href="services.php?category=home">Home Services</a></li>
                    <li><a href="services.php?category=salon">Salon Services</a></li>
                    <li><a href="services.php?category=garage">Garage Services</a></li>
                    <li><a href="services.php">Browse All</a></li>
                </ul>
            </div>
