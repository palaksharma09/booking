...
<section class="booking-main-section">
    <div class="booking-form-card" style="max-width: 900px; margin: 0 auto;">
        ...
        <div class="info-grid">
            ...
            <div class="info-row"><span class="info-label">Cancellations</span><span class="info-value">Customers may cancel without charge up to 24 hours before the appointment unless stated otherwise.</span></div>
            <div class="info-row"><span class="info-label">Conduct</span><span class="info-value">Users must provide accurate contact details and a safe service location.</span></div>
        </div>
    </div>
</section>
